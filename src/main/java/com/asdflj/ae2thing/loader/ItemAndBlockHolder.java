...
import com.asdflj.ae2thing.common.block.BlockEssenceDiscretizer;
...
public class ItemAndBlockHolder {
    ...
    public static BlockEssenceDiscretizer ESSENCE_DISCRETIZER = new BlockEssenceDiscretizer().register();
